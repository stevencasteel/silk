...
const physLeft = BABYLON.MeshBuilder.CreateBox("physLeft", { width: 1.0, height: 140, depth: 6 }, scene);
...
const physRight = BABYLON.MeshBuilder.CreateBox("physRight", { width: 1.0, height: 140, depth: 6 }, scene);
