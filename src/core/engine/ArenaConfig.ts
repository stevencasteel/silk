...
export const ARENA_CONFIG = {
  ...
  ENTITY_COLORS: {
    WEAVER_ALBEDO: { r: 0.12, g: 0.0, b: 0.22 },
...
export const GAMEPLAY_TUNING = {
  ...
  PLAYER: {
    ...
    TENSION: {
      TAUTNESS_THRESHOLD: 0.85,
      DECAY_MULTIPLIER: 2.0,
      MAX_ACHIEVABLE_TENSION: 1.0,
      BUILD_IN_AIRBORNE: true,
      BUILD_IN_LAUNCHING: true
    },
    FLING: {
      MIN_MULTIPLIER: 0.35,
      MAX_MULTIPLIER: 2.2,
      ...
      LOW_TENSION_NUDGE_DISTANCE: 0.35,
      LOW_TENSION_NUDGE_SPEED: 5.5,
      LOW_TENSION_MIN_VEL_Y: -3.0,
      SAFE_LAUNCH_DURATION: 0.4
    },
    COSMETIC: {
      OVERLOAD_SCALE_VEL_Y: 36.0,
      OVERLOAD_SCALE_VEL_X: -18.0,
      OVERLOAD_SCALE_VEL_Z: -18.0,
      SWEET_SPOT_SCALE_VEL_Y: 22.0,
      SWEET_SPOT_SCALE_VEL_X: -11.0,
      SWEET_SPOT_SCALE_VEL_Z: -11.0,
      HITSTOP_OVERLOAD: 0.1,
      HITSTOP_SWEET_SPOT: 0.08,
      HITSTOP_SWEET_SPOT_SCALE: 0.15
    }
  },
  COMBAT: {
    ...
    HAZARD_COLLISION_RADIUS_NORMAL: 2.4 as number,
    HAZARD_COLLISION_RADIUS_SPIKED: 3.4 as number,
    WEB_IMPACT_KNOCKBACK_X: 18.0,
    WEB_IMPACT_KNOCKBACK_Y: 8.0,
    WEB_IMPACT_SLACK_INCREASE: 6.0
  },
  REEL: {
    MIN_LENGTH: 5.4,
    MAX_LENGTH: 38.0,
    IN_SPEED: 10.0,
    OUT_SPEED: 14.0,
    MANUAL_IN_SPEED: 16.0,
    AUTO_SLACK_MARGIN: 0.5,
    MIN_LENGTH_OFFSET: 0.5,
...
export const VISUAL_JUICE_CONFIG = {
  ...
  TETHER_ROPE: {
    ...
    TENSION_VIB_HIGH_TENSION_MULT: 2.5,
    TENSION_VIB_HIGH_TENSION_FREQ_MULT: 3.5,
    WAVINESS_FREQ: 0.005,
    WAVINESS_AMP: 0.12,
    WAVINESS_STRETCH: 2.5,
    BEZIER_DEPTH: 0.35,
    MAX_SNAP_DURATION_SECONDS: 1.5,
    SAG_LOW_TENSION_MULT: 1.3,
    SAG_SWEET_SPOT_MULT: 0.15,
    SAG_REEL_IN_MIN: 0.15,
    SAG_REEL_OUT_MULT: 0.4,
    WAVE_LOW_TENSION_MULT: 1.8,
    WAVE_SWEET_SPOT_MULT: 0.35,
    WAVE_HIGH_TENSION_MULT: 0.1,
    RADIUS_LOW_TENSION_MULT: 0.85,
    RADIUS_SWEET_SPOT_MULT: 1.1,
    RADIUS_PULSE_FREQ: 0.03,
    RADIUS_PULSE_AMP: 0.015
  },
  TETHER_UI: {
    COLOR_GREEN: { r: 34, g: 197, b: 94 },
    COLOR_YELLOW: { r: 234, g: 179, b: 8 },
    COLOR_RED: { r: 239, g: 68, b: 68 },
  ...
  COCOON_COLORS: {
    DECAY_START: { r: 1.0, g: 1.0, b: 1.0 },
    DECAY_MID: { r: 0.88, g: 0.75, b: 0.35 },
    DECAY_END: { r: 0.15, g: 0.15, b: 0.15 }
  }
} as const;
