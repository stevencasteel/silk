...
export class EntitySpawnerSystem implements ISystem {
  ...
  public init(): void {
    ...
    // 2. Warden Entity (Ceiling Sweep Anchor) - Giant 3D Spider configuration
    ...
    // Giant Spider Mech Sphere (Radius 2.4 - 3x capsule width width)
    ...
    // Dynamic swing tether is 10.0 units starting length
