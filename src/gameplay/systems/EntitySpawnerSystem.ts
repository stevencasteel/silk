...
this.targets.add(weaverId, { x: 0, y: 28.0, z: 0, active: true });
...
wMat.albedoColor = new BABYLON.Color3(0.08, 0.08, 0.09);
wMat.metallic = 0.95;
wMat.roughness = 0.15;
wMesh.material = wMat;
...
anchorX: 0, anchorY: 28.0, anchorZ: 0,
...
pMat.albedoColor = new BABYLON.Color3(0.85, 0.85, 0.88);
pMat.metallic = 0.1;
pMat.roughness = 0.4;
pMesh.material = pMat;
