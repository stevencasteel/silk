    ...
    constructor(
        ...
        private wardenTraversal: ComponentStore<WardenTraversalComponent>
            ...
            public init(): void {
                ...
                this.targets.add(wardenId, { x: 0, y: 27.2, z: 0, active: true });
                this.wardenAIs.add(wardenId, { state: "SWEEPING", timeInState: 0, targetX: 0, targetY: 27.2, hue: "#ef4444", hasFakedDeath: false });
