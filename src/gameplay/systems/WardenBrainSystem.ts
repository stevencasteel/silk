...
export class WardenBrainSystem implements ISystem {
  ...
  constructor(
    ...
    this.ctx = { wardenId: -1, playerId: -1, ai: null as any, transforms: this.transforms, wardenTraversal: this.wardenTraversal, commands: this.commands, broker: this.broker };
  }
