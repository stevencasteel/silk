...
import { TransformComponent, HealthComponent, TetherComponent, WardenAIComponent, KinematicVelocityComponent, InvulnerabilityComponent, KinematicTargetComponent } from "../../core/ecs/Components";
...
export class GameDirectorSystem implements ISystem {
  ...
  private resetGame(): void {
    ...
    // 1. Reset Player to hanging position
    ...
    // 2. Reset Warden to the ceiling sweep start
...
const tether = { anchorX: 0, anchorY: 26, anchorZ: 0, maxLength: 10.0, currentLength: 10.0, isAttached: true, tension: 0.0, dynamicVelX: 0.0, dynamicVelY: 0.0 };
