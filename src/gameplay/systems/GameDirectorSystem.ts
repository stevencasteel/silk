...
if (pTrans) {
pTrans.x = 0; pTrans.y = 10.0; pTrans.z = 0;
pTrans.prevX = 0; pTrans.prevY = 10.0; pTrans.prevZ = 0;
}
if (pTarget) {
pTarget.x = 0; pTarget.y = 10.0; pTarget.z = 0; pTarget.active = true;
}
...
pTrav.wallNormalX = 0; pTrav.wallNormalY = 0; pTrav.wallDir = 0;
pTrav.launchTimer = 0; pTrav.launchPower = 0;
}
...
if (wVel) { wVel.x = 4.5; wVel.y = 0; wVel.z = 0; }
...
this.broker.publish(GameEvent.WEAVER_STATE_CHANGE, { state: "SWEEPING", hue: this.HASH + "ef4444" });
