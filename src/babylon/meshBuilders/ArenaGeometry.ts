...
const leftTick = BABYLON.MeshBuilder.CreateBox(`leftTick_${i}`, { width: 0.2, height: 0.08, depth: 2.1 }, this.scene);
...
const rightTick = BABYLON.MeshBuilder.CreateBox(`rightTick_${i}`, { width: 0.2, height: 0.08, depth: 2.1 }, this.scene);
