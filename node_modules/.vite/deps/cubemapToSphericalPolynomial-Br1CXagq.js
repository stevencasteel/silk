import { n as Observable } from "./observable-BzDHPT8D.js";
import { a as Vector3, c as _ObserveArray, f as ToLinearSpace, i as Vector2, r as TmpVectors, t as Matrix } from "./math.vector-ORlXLKk4.js";
import { r as RegisterClass, t as GetClass } from "./typeStore-B6gLvgx1.js";
import { t as EngineStore } from "./engineStore-DYy4YDtS.js";
import { t as Clamp } from "./math.scalar.functions-CHdlcjTH.js";
import { t as Color3 } from "./math.color-B9yc3YuY.js";
import { t as Logger } from "./logger-DtGENBsi.js";
import { _ as __decorate, o as serializeAsColor4, r as serialize } from "./decorators-CoS6v31S.js";
import { n as SerializationHelper } from "./math.size-DNFwQMAZ.js";
import { i as IsDocumentAvailable, o as IsWindowObjectExist, t as PrecisionDate } from "./precisionDate-Caj1jQ-l.js";
import { N as _retryWithInterval, U as allocateAndCopyTypedBuffer, a as NearestPOT, d as InternalTexture, n as GetExponentOfTwo, o as AbstractEngine, r as IsExponentOfTwo, t as FloorPOT, v as Effect } from "./tools.functions-CroJYqv2.js";
import { a as PostProcessManager, o as SmartArray, r as RenderingManager } from "./math.frustum-CjcBRX3w.js";
import { t as PerfCounter } from "./perfCounter-DuwZCRAc.js";
import "./math.plane-D3RMynno.js";
import "./math.path-DmFXp15H.js";
import { n as EffectWrapper } from "./effectRenderer-BC6qS9mB.js";
import { o as BaseTexture, t as Texture } from "./texture-BZzwDbhE.js";
import { i as HasStencilAspect, o as WebGLHardwareTexture, s as WebGLDataBuffer, t as ThinEngine } from "./thinEngine-1JGJqT40.js";
...
var PostProcess = class PostProcess {
	...
	*/
	...
	_gatherImports(useWebGPU = false, list) {
		if (useWebGPU && this._webGPUReady) list.push(Promise.all([import("./@babylonjs_core.js").then((n) => n.a)]));
		else list.push(Promise.all([import("./postprocess.vertex-Cv67xkiL.js").then((n) => n.n)]));
	}
	/**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
	const callback = async (loadData) => {
		...
		if (!width) return;
		const { DDSTools } = await import("./dds-C6DJNGIO.js").then((n) => n.n);
		const textures = [];
...
var ThinPassPostProcess = class ThinPassPostProcess extends EffectWrapper {
	_gatherImports(useWebGPU, list) {
		if (useWebGPU) {
			...
			list.push(Promise.all([import("./@babylonjs_core.js").then((n) => n.n)]));
		} else list.push(Promise.all([import("./@babylonjs_core.js").then((n) => n.i)]));
...
var ThinPassCubePostProcess = class ThinPassCubePostProcess extends EffectWrapper {
	_gatherImports(useWebGPU, list) {
		if (useWebGPU) {
			this._webGPUReady = true;
			list.push(Promise.all([import("./@babylonjs_core.js").then((n) => n.t)]));
		} else list.push(Promise.all([import("./@babylonjs_core.js").then((n) => n.r)]));
		super._gatherImports(useWebGPU, list);
	}
	/**
	...
	*/
	isReadyForRendering() {
		if (!this._dumpToolsLoading) {
			...
			import("./dumpTools-tNyd0w6v.js").then((n) => n.i).then((module) => this._dumpTools = module);
		}
...
var ProcessAsync = async (texture, width, height, face, lod) => {
	const scene = texture.getScene();
	const engine = scene.getEngine();
	if (!engine.isWebGPU) if (texture.isCube) await import("./@babylonjs_core.js").then((n) => n.l);
	else await import("./@babylonjs_core.js").then((n) => n.c);
	else if (texture.isCube) await import("./@babylonjs_core.js").then((n) => n.s);
	else await import("./@babylonjs_core.js").then((n) => n.o);
	let lodPostProcess;
...
//#endregion
export { RollingAverage as A, _CommonInit as C, PositionNormalVertex as D, PositionNormalTextureVertex as E, Axis as M, Coordinate as N, RenderTargetWrapper as O, Space as P, _CommonDispose as S, SphericalPolynomial as T, ExitPointerlock as _, GetTextureDataAsync as a, RequestPointerlock as b, RenderTargetTexture as c, PassPostProcess as d, ThinPassCubePostProcess as f, ExitFullscreen as g, CreateImageBitmapFromSource as h, FromHalfFloat as i, PostProcess as j, PerformanceMonitor as k, ObjectRenderer as l, Engine as m, ApplyPostProcess as n, TextureTools as o, ThinPassPostProcess as p, CreateResizedCopy as r, ToHalfFloat as s, CubeMapToSphericalPolynomialTools as t, PassCubePostProcess as u, GetFontOffset as v, SphericalHarmonics as w, ResizeImageBitmap as x, RequestFullscreen as y };

//# sourceMappingURL=cubemapToSphericalPolynomial-Br1CXagq.js.map