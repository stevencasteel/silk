...
import { a as Vector3, c as _ObserveArray, f as ToLinearSpace, i as Vector2, r as TmpVectors, t as Matrix } from "./math.vector--hYtoK0-.js";
import { r as RegisterClass, t as GetClass } from "./typeStore-B6gLvgx1.js";
import { t as EngineStore } from "./engineStore-DYy4YDtS.js";
import { t as Clamp } from "./math.scalar.functions-CKVCLhxz.js";
import { t as Color3 } from "./math.color-CnXWgTxr.js";
...
import { n as SerializationHelper } from "./math.size-DoQHCZ5u.js";
...
import { a as PostProcessManager, o as SmartArray, r as RenderingManager } from "./math.frustum-Csp3k2aQ.js";
import { t as PerfCounter } from "./perfCounter-DuwZCRAc.js";
import "./math.plane-D6iL_V5N.js";
import "./math.path-CFZ52stG.js";
import { n as EffectWrapper } from "./effectRenderer-BsBnxoSP.js";
import { o as BaseTexture, t as Texture } from "./texture-B9IWAYMa.js";
import { i as HasStencilAspect, o as WebGLHardwareTexture, s as WebGLDataBuffer, t as ThinEngine } from "./thinEngine-BB0U-xG9.js";
...
var PostProcess = class PostProcess {
	...
	*/
	...
	_gatherImports(useWebGPU = false, list) {
		...
		else list.push(Promise.all([import("./postprocess.vertex-B0RVHAhu.js").then((n) => n.n)]));
	}
	/**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
	const callback = async (loadData) => {
		...
		if (!width) return;
		const { DDSTools } = await import("./dds-DSJw8Rod.js").then((n) => n.n);
		const textures = [];
	...
	*/
	isReadyForRendering() {
		if (!this._dumpToolsLoading) {
			...
			import("./dumpTools-8WaloC26.js").then((n) => n.i).then((module) => this._dumpTools = module);
		}
...
//# sourceMappingURL=cubemapToSphericalPolynomial-BL6rHNHj.js.map