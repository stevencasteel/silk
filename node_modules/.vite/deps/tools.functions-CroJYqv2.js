...
import { n as PerformanceConfigurator, t as EngineStore } from "./engineStore-DYy4YDtS.js";
import { t as Logger } from "./logger-DtGENBsi.js";
import { t as _WarnImport } from "./devTools-CHk0U29u.js";
import { a as IsNavigatorAvailable, i as IsDocumentAvailable, o as IsWindowObjectExist, r as GetDOMTextContent, t as PrecisionDate } from "./precisionDate-Caj1jQ-l.js";
...
function _GetCompatibleTextureLoader(extension, mimeType) {
	...
	if (!_registeredTextureLoaders.has(extension)) {
		if (extension.endsWith(".ies")) registerTextureLoader(".ies", () => import("./@babylonjs_core.js").then((n) => n.u).then((module) => new module._IESTextureLoader()));
		if (extension.endsWith(".dds")) registerTextureLoader(".dds", () => import("./@babylonjs_core.js").then((n) => n._).then((module) => new module._DDSTextureLoader()));
		if (extension.endsWith(".basis")) registerTextureLoader(".basis", () => import("./@babylonjs_core.js").then((n) => n.f).then((module) => new module._BasisTextureLoader()));
		if (extension.endsWith(".env")) registerTextureLoader(".env", () => import("./@babylonjs_core.js").then((n) => n.g).then((module) => new module._ENVTextureLoader()));
		if (extension.endsWith(".hdr")) registerTextureLoader(".hdr", () => import("./@babylonjs_core.js").then((n) => n.p).then((module) => new module._HDRTextureLoader()));
		if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
			registerTextureLoader(".ktx", () => import("./@babylonjs_core.js").then((n) => n.h).then((module) => new module._KTXTextureLoader()));
			registerTextureLoader(".ktx2", () => import("./@babylonjs_core.js").then((n) => n.h).then((module) => new module._KTXTextureLoader()));
		}
		if (extension.endsWith(".tga")) registerTextureLoader(".tga", () => import("./@babylonjs_core.js").then((n) => n.m).then((module) => new module._TGATextureLoader()));
		if (extension.endsWith(".exr")) registerTextureLoader(".exr", () => import("./@babylonjs_core.js").then((n) => n.d).then((module) => new module._ExrTextureLoader()));
	}
...
//# sourceMappingURL=tools.functions-CroJYqv2.js.map