...
import { n as EffectWrapper, t as EffectRenderer } from "./effectRenderer-BsBnxoSP.js";
...
async function _CreateDumpRenderer() {
	if (!_enginePromise) _enginePromise = new Promise((resolve, reject) => {
		...
		import("./thinEngine-BB0U-xG9.js").then((n) => n.n).then(({ ThinEngine: thinEngineClass }) => {
			...
			import("./@babylonjs_core.js").then((n) => n.i).then(({ passPixelShader }) => {
				if (!engine) {
...
//# sourceMappingURL=dumpTools-8WaloC26.js.map